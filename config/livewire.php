...
return [
    ...
    */
    ...
    'temporary_file_upload' => [
        ...
        'rules' => ['required', 'file', 'max:20480'], // 20MB - matches PhotoUploader's per-file limit. Kept generic (no mimes) since PageManager also uses WithFileUploads for non-image downloads (PDF, zip, ...) with its own stricter rules.
