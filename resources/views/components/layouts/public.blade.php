    ...
    <div class="flex min-h-screen flex-col">
        <header class="border-b border-zinc-200 dark:border-zinc-700">
            <div class="mx-auto flex max-w-5xl items-center justify-between gap-6 px-6 py-4">
                <a href="{{ route('home') }}" class="font-mono text-lg font-semibold text-zinc-900 dark:text-zinc-100" wire:navigate>
                    {{ config('app.name') }}
                </a>
        ...
        <footer class="border-t border-zinc-200 dark:border-zinc-700">
            <div class="mx-auto flex max-w-5xl flex-col items-center gap-4 px-6 py-8 text-sm text-zinc-500 sm:flex-row sm:justify-between">
