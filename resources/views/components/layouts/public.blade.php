            ...
            <div class="mx-auto flex max-w-5xl items-center justify-between gap-6 px-6 py-4">
                ...
                <div class="flex gap-3">
                    @if ($siteSettings->social_instagram_url)
                        <a href="{{ $siteSettings->social_instagram_url }}" target="_blank" rel="noopener"
                    ...
                    @endif
                    @if ($siteSettings->social_linkedin_url)
                        <a href="{{ $siteSettings->social_linkedin_url }}" target="_blank" rel="noopener"
                            class="text-zinc-500 hover:text-zinc-900 dark:hover:text-zinc-100">
                            <svg viewBox="0 0 24 24" class="size-4 fill-current" aria-label="LinkedIn">
